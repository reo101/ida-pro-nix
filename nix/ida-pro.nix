        ...
        let
          ...
          mkHexlic =
            ...
            let
              ...
              unsignedLicense = builtins.toFile "idapro-unsigned.hexlic" (
                lib.toJSON {
                  header.version = 1;
                  inherit payload;
                }
              ...
              signatureInput = builtins.toFile "idapro-signature-input.json" (lib.toJSON { inherit payload; });
            in
            derivation {
              inherit system;
              ...
              args = [
                ...
                /* bash */ ''
                  ...
                  hash="$(sha256sum "${signatureInput}" | cut -d ' ' -f 1 | tr '[:lower:]' '[:upper:]')"
                  message="${lib.strings.replicate 33 "42"}''${hash}${lib.strings.replicate 63 "00"}"
